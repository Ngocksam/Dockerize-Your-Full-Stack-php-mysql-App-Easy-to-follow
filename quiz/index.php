...
{
echo "<h1 class='style8' align=center>ONLINE EXAM</h1>";
		echo '<table width="28%"  border="0" align="center">
  <tr>
    <td width="7%" height="65" valign="bottom"><img src="image/HLPBUTT2.JPG" width="50" height="50" align="middle"></td>
    <td width="93%" valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4">Choose Subjects for Quiz </a></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
      <div class="on">  <h1 class="style8">WELCOME TO ONLINE QUIZ</h1> </div>
...
<p align="left" class="style5"> </p>
      <blockquote>
          <p align="left" class="style5"><span class="style7"><h2>Welcome to Online
            exam. This Site will provide the quiz for various subject of interest.
            <b><br>To Start Quiz you need to login first.</b></br>
					<br>No login account?? No problem, sign up now for free!!</br></h2></span></p>
      </blockquote>
    </div></td>
